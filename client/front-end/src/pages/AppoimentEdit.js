...
const AppointmentsEdit = ({ appointment = {}, message, goods = [], checkLines = [] }) => {
        ...
        <form onSubmit={handleSubmit}>
          <div className="row">
            <div className="row col-12 justify-content-between">
              ...
              <h3 className="mb-0">{true ? 'Пол пациента: Мужской' : 'Пол пациента: Женский'}</h3>
            </div>
          </div>
          <div className="row col-12 justify-content-between">
            <div className="row col-4">
              <h4>Заключение</h4>
              <textarea rows="15" value={appointment.conclusion} disabled={readOnly} name="conclusion" onChange={handleInputChange} />
            </div>
